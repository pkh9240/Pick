		...
		<div class="row">
			<form id="pick_form">
				<div class="col s5">
					...
					<label for="cb1" class="tooltipped" data-position="top" data-delay="50" data-tooltip="${vote.choiceList.get(0).content}"> <img id="first_img" src="/image/vote/thumbnail/${vote.choiceList.get(0).photo}" />
